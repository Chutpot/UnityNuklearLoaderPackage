...
namespace NuklearDotNet {
	...
	public static unsafe partial class Nuklear {
        ...
        [DllImport(DllName, CallingConvention = CConv, CharSet = CSet)]
        public static extern int nk_group_set_scroll(nk_context* ctx, string id, uint x_offset, uint y_offset);
        ...
        [DllImport(DllName, CallingConvention = CConv, CharSet = CSet)]
        public static extern int nk_option_label(nk_context* ctx, string s, int active);
        ...
        [DllImport(DllName, CallingConvention = CConv, CharSet = CSet)]
        public static extern void nk_property_int(nk_context* ctx, string name, int min, int* val, int max, int step, float inc_per_pixel);
        ...
        [DllImport(DllName, CallingConvention = CConv, CharSet = CSet)]
        public static extern float nk_propertyf(nk_context* ctx, string name, float min, float val, float max, float step, float inc_per_pixel);
        ...
        [DllImport(DllName, CallingConvention = CConv, CharSet = CSet)]
        public static extern int nk_combo_begin_color(nk_context* ctx, nk_colorf color, nk_vec2 size);
